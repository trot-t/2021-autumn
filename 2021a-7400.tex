...
\Title{Ведомость Преобразователи энергии (Power Convertors) 7400, осень\textemdash\thisyear} % год поставится сам
\Author{Прокшин Артем Николаевич}
\Creator{pdfTeX + pdfx.sty with options \pdfxopts }
\Subject{Ведомость посещения занятий и выполнения лабораторных работ по Преобразователям энергии (Power Convertors) студентами 7400 группы, осень 2021}
\Keywords{ведомость посещения, группа 7400, ЛЭТИ}
...
\multicolumn{11}{c}{Attendance list (Power Convertors)  students of 7400 group} \\
\toprule 
&&&&&&&&&&\\
&&&&&&&&&&\\
&&&&&&&&&&\\
...
&\rotatebox{90}{\rlap{\small November 27 boost}}
&\rotatebox{90}{\rlap{\small December 4 }}
&\rotatebox{90}{\rlap{\small December 11}}
...
2\,& Аднан Мухаммад                      \no\no\no\ok\ok\ok\ok\\
3\,& Азгауи Усама                        \no\no\no\ok\no\ok\ok\\
4\,& Бала Барнабас Симон                 \ok\ok\ok\no\no\ok\ok\\
5\,& Коирала Нишан                       \no\no\no\no\ok\ok\ok\\
\midrule              
6\,& Потупития Канканамге Разика Таранга \ok\no\no\ok\no\ok\ok\\
7\,& Семин Илья Алексеевич               \ok\ok\ok\ok\ok\ok\ok\\
8\,& Сенаторов Семен Николаевич          \ok\ok\ok\ok\ok\ok\ok\\
9\,& Сердюк Артем Петрович               \ok\no\ok\ok\no\ok\ok\\
\bottomrule
\end{tabular} 
\newpage
%
...
\multicolumn{10}{c}{выполнение лабораторнах работ по Преобразователям энергии (Power Convertors), 7400 группа} \\
\toprule
...
2\,& Аднан Мухаммад                      \\
3\,& Азгауи Усама                        \\
4\,& Бала Барнабас Симон                 \\
5\,& Коирала Нишан                       \\
\midrule
6\,& Потупития Канканамге Разика Таранга \\
7\,& Семин Илья Алексеевич               \\
8\,& Сенаторов Семен Николаевич          \\
9\,& Сердюк Артем Петрович               \\
\bottomrule
\end{tabular}
