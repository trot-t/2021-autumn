...
\multicolumn{11}{c}{Ведомость посещения занятий по Преобразователям энергии (Power Convertors) студентами 7400 группы} \\
\toprule 
&&&&&&&&&&\\
&&&&&&&&&&\\
&&&&&&&&&&\\
...
7\,& Семин Илья Алексеевич               \ok\ok\ok\ok\\
8\,& Сенаторов Семен Николаевич          \ok\ok\ok\ok\\
